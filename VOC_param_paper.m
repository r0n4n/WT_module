...
%***********************************************************************
n = 750 ; % speed (tr/min) 750 for 50 Hz
fluxeff =  0.15 ;
Ka = fluxeff ;
p = 4 ;  % nombre de paires de pôles


Eg = 47 ;  % Phase-to-ground voltage amplitude
Rg = 1e-3; % 1e-2
Lg = 1e-5; % 1e-4
...
RL = 150; % Output load, Pout about 800W
Rload_temp = 1e5; % Temporary output load to avoid discharge of C
Udcref = 120; % Output voltage reference
initial_condition_integrator = Udcref; % IC model integrator
